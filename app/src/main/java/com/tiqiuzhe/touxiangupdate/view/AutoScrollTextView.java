...
public class AutoScrollTextView extends TextSwitcher implements
    ...
    public AutoScrollTextView(Context context, AttributeSet attrs) {
        ...
        mTextSize = a.getDimension(R.styleable.autoScrollHeight_textSize_Scroll, 24);
        ...
        textColor = a.getColor(R.styleable.autoScrollHeight_textColor_Scroll, Color.BLACK);
        a.recycle();
        init();
    }
